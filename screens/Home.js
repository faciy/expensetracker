...
const Home = () =>{
               ...
               backgroundColor:COLORS.white
                ...
                <View style={{
                    ...
                    <View style={{marginLeft: SIZES.padding}}>
                        <Text style={{color:COLORS.primary, ...FONTS.h3}}>O7 Feb, 2021 </Text>
    ...
    function renderCategoryHedaerSection () {
        return(
            <View style={{
                flexDirection:'row',justifyContent:'space-between',padding:SIZES.padding, alignItems:'center'
            }}>
                {/* Title */}
                    <View>
